...
public class ChoucairLoginPage extends PageObject {
    public static final Target LOGIN_BUTTON = Target.the("buttom that shows us form to login")
    ...
    public static final Target ENTER_BUTTON = Target.the("buttoms to confirms login")
