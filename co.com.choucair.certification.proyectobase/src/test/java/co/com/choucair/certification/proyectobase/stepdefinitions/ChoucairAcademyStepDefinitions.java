...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanHernanWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData)
            throws Exception {
        OnStage.theActorCalled("Hernan").wasAbleTo(OpenUp.thePage(),(Login.
